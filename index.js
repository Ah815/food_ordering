...
for (var i = 0; i < foodItems.length; i++) {
    ...
    <div class="card" style="width: 18rem">
      ...
      <div  class="card-body">
        ...
        <button onclick="addtofavourite(this)"> <i class=" heart fa-regular fa-heart" id="heartpic"></i>
    </div>
  </div>`
...
function addtofavourite(btn) {
    ...
    favouriteitems.push(obj)
    fv.innerText = `Favourites (${favouriteitems.length})`
